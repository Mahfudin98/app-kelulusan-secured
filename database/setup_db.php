...
try {
    ...
    $defaultTemplate = '<p style="text-indent: 30px; text-align: justify;">Kepala [nama_sekolah] selaku Ketua Penyelenggara Ujian Sekolah Tahun Pelajaran [tahun_pelajaran] berdasarkan Keputusan Kepala Sekolah dan Rapat Dewan Guru, menerangkan bahwa:</p><table style="margin-left: 30px; width: 100%; margin-bottom: 20px; border-collapse: collapse;"><tbody><tr><td style="width: 200px; padding: 5px 0;">Nama Lengkap</td><td style="width: 20px; padding: 5px 0;">:</td><td style="padding: 5px 0;"><strong>[nama_siswa]</strong></td></tr><tr><td style="padding: 5px 0;">Tempat, Tanggal Lahir</td><td style="padding: 5px 0;">:</td><td style="padding: 5px 0;">[tempat_lahir], [tanggal_lahir]</td></tr><tr><td style="padding: 5px 0;">Nomor Induk Siswa Nasional (NISN)</td><td style="padding: 5px 0;">:</td><td style="padding: 5px 0;">[nisn]</td></tr><tr><td style="padding: 5px 0;">Jenis Kelamin</td><td style="padding: 5px 0;">:</td><td style="padding: 5px 0;">[jenis_kelamin]</td></tr><tr><td style="padding: 5px 0;">Jurusan / Program Studi</td><td style="padding: 5px 0;">:</td><td style="padding: 5px 0;">[jurusan]</td></tr></tbody></table><p style="text-indent: 30px; text-align: justify;">Berdasarkan hasil nilai ujian dan kriteria kelulusan yang telah ditetapkan, siswa tersebut di atas dinyatakan:</p><div style="text-align: center; font-size: 24pt; font-weight: bold; margin: 30px 0; border: 2px solid #000; padding: 10px; letter-spacing: 5px;">[status_kelulusan]</div><p style="text-indent: 30px; text-align: justify;">Telah menyelesaikan seluruh program pembelajaran dan memperoleh nilai rata-rata: <strong>[nilai_rata_rata]</strong>.</p><p style="text-indent: 30px; text-align: justify;">Demikian Surat Keterangan Lulus ini dibuat dengan sebenarnya agar dapat dipergunakan sebagaimana mestinya.</p>';
    $headerTemplate = '<table style="width: 100%; border-bottom: 4px solid #000; padding-bottom: 10px; margin-bottom: 20px; border-collapse: collapse;"><tr><td style="width: 80px; text-align: left; vertical-align: middle;"><img src="[logo_sekolah]" alt="Logo" style="width: 80px; height: auto;"></td><td style="text-align: center; vertical-align: middle; padding: 0 10px;"><p style="font-size: 14pt; font-weight: bold; margin: 0; text-transform: uppercase;">DINAS PENDIDIKAN</p><h1 style="font-size: 18pt; font-weight: bold; margin: 2px 0; text-transform: uppercase;">[nama_sekolah]</h1><p style="font-size: 10pt; margin: 0;">[alamat]<br>Website: [website] | Email: [email] | Telp: [telepon]</p></td><td style="width: 80px;"></td></tr></table>';
    $footerTemplate = '<table style="width: 100%; margin-top: 30px; border-collapse: collapse;"><tr><td style="width: 60%;"></td><td style="width: 40%; text-align: left; padding-left: 30px;"><div style="margin-bottom: 5px;">Ditetapkan di: ____________<br>Pada tanggal: [tanggal_surat]</div><div style="margin-bottom: 60px;">Kepala Sekolah,</div><div style="font-weight: bold; text-decoration: underline;">[kepala_sekolah]</div><div style="margin-top: 5px;">NIP. [nip_kepala_sekolah]</div></td></tr></table>';
